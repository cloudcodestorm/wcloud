...
class ChargingResponse
{
    ...
    /**
     * Strip the attempts count and return the Order ID
     * @return string Order ID
     */
    public function get_merchant_transaction_id()
    {
        $raw_id =  $this->params[Constants::PARAMETER_MERCHANT_TRANSACTION_ID];
        $pos = strrpos($raw_id, '_');
        return substr($raw_id, 0, $pos);
    }
