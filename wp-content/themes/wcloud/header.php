...
<body <?php body_class(); ?>>
	<div id="page" class="hfeed site">
		...
		<div class="logo-placeholder">
			...
			<div id="banner_title">World's Most Affordable Cloud Backup</div>
		...
		<div id="bgbanner"></div>            <div class="serial-key">			<form role="serialkey" method="post" class="search-form" action="action.php">					<label>						<span class="serialkey_text">Enter Serial Key</span>						<input type="text" name="keytext" title="keytext" />					</label>					<input type="submit" value="Enter Serial Key" />				</form>			</div>
